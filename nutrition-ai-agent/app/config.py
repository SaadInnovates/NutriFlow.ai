...
class Settings:
	def __init__(self) -> None:
		...
		self.max_tokens = int(os.getenv("MODEL_MAX_TOKENS", "3200"))
		self.max_continuation_attempts = int(os.getenv("MODEL_MAX_CONTINUATION_ATTEMPTS", "2"))
		...
		self.plan_context_max_chars = int(os.getenv("PLAN_CONTEXT_MAX_CHARS", "2800"))
		...
		self.preload_vectorstore_on_startup = _as_bool("PRELOAD_VECTORSTORE_ON_STARTUP", False)
		self.preload_agent_on_startup = _as_bool("PRELOAD_AGENT_ON_STARTUP", False)
